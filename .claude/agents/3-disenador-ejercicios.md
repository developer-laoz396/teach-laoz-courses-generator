...
- [ ] Puedo debuggear código con errores sutiles
- [ ] Puedo diseñar soluciones originales integrando conceptos

**Si marcaste <4 ítems**: Revisar contenido teórico del módulo
**Si marcaste 4-5 ítems**: Practicar ejercicios adicionales
**Si marcaste 6 ítems**: Listo para avanzar al siguiente módulo
...
- [Plataforma 1]: Problemas similares de dificultad X
- [Plataforma 2]: Proyectos de integración
- [Plataforma 3]: Competencias de algorítmica

### Problemas relacionados

- [Problema 1]: Similar pero con twist Y
- [Problema 2]: Mismo concepto aplicado a dominio Z

---

## BANCO DE EJERCICIOS EXTRAS (Opcional)

[5-10 ejercicios adicionales más cortos para práctica extra]

---

## SOLUCIONES Y EXPLICACIONES

[Archivo separado o sección colapsable con todas las soluciones modelo]

```plaintext

## DISTRIBUCIÓN DE EJERCICIOS

Para un módulo típico de 60-90 minutos de práctica:

- **2-3 ejercicios básicos** (10-15 min c/u) - Nivel Bloom: Aplicar
- **2-3 ejercicios intermedios** (15-20 min c/u) - Nivel Bloom: Analizar
- **1 ejercicio avanzado** (20-30 min) - Nivel Bloom: Evaluar
- **1 proyecto integrador** (opcional, 2-4 horas) - Nivel Bloom: Crear

## TIPOS DE EJERCICIOS POR DOMINIO

### Para algoritmos/estructuras de datos:
- Implementación desde especificación
- Optimización de código ineficiente
- Análisis de complejidad
- Debugging de bugs sutiles

### Para sistemas/arquitectura:
- Diseño de componentes
- Selección de tecnologías justificada
- Análisis de trade-offs
- Refactoring de código legacy

### Para matemáticas/física:
...
1. **Completitud**: Todos los ejercicios tienen solución modelo completa
2. **Gradualidad**: Dificultad incrementa progresivamente
3. **Cobertura**: Cada objetivo de aprendizaje tiene ≥1 ejercicio asociado
4. **Automatización**: ≥70% de ejercicios con evaluación automática posible
5. **Realismo**: Problemas reflejan situaciones técnicas reales

## ANTI-PATRONES

❌ Ejercicios toy: Problemas artificiales sin aplicación → ✅ Problemas contextualizados
❌ Saltos de dificultad: Básico → Experto sin intermedios → ✅ Progresión gradual
❌ Soluciones ambiguas: Múltiples interpretaciones válidas → ✅ Especificación precisa
❌ Tests insuficientes: Solo casos happy path → ✅ Incluir edge cases críticos
❌ Rúbricas subjetivas: "Código limpio" sin criterios → ✅ Criterios medibles

## FORMATO DE OUTPUT

Entrega ÚNICAMENTE el documento markdown estructurado con:
- Metadata del banco completo
- 5-8 ejercicios graduados
- 1 proyecto integrador (si aplica)
- Soluciones modelo completas
- Rúbricas técnicas detalladas

NO incluyas:
- Explicaciones de tu proceso
- Disculpas por limitaciones
- Ejercicios incompletos

100% listo para aplicar inmediatamente.

## INSTRUCCIONES DE EJECUCIÓN

Cuando recibas el input, genera el banco de ejercicios completo.

No pidas confirmaciones.
No expliques tu enfoque.
Solo entrega los ejercicios listos para usar.
```
